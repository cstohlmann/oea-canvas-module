...
| User Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
...
| [Canvas Resource: List Courses for a User](https://canvas.instructure.com/doc/api/all_resources.html#method.courses.user_index) | Details on how to get a list of courses for a particular user. | ```GET /api/v1/users/:user_id/courses``` | [x] |
| [Canvas Resource: List Users in Course](https://canvas.instructure.com/doc/api/courses.html#method.courses.users) | Details on how to get a list of all users for a particular course. | ```GET /api/v1/courses/:course_id/users``` | [ ] |
...
| Section Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
| [Canvas Resource: List Course Sections](https://canvas.instructure.com/doc/api/all_resources.html#method.sections.index) | Details on how to get a paginated list of sections for a particular course. | ```GET /api/v1/courses/:course_id/sections```| [ ] |

### Course-Related Tables

| Course Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
...
| Quiz Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
...
| Activity Stream Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
| [Canvas Resource: List the Activity Stream](https://canvas.instructure.com/doc/api/all_resources.html#method.users.activity_stream) | Details on how to get a paginated list of the current user's global activity stream. | ```GET /api/v1/users/activity_stream``` | [ ] |
...
| Assignment Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
...
| Calendar Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
...
| Announcement Tables | Description | API Call | Microsoft-Documented as Valuable |
| --- | --- | --- | --- |
