...
eval "az synapse pipeline create --workspace-name $synapse_workspace --name 1_land_canvas_prod_data --file @$this_file_path/pipeline/1_land_canvas_prod_data.json"
